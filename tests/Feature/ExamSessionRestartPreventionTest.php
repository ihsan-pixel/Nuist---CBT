...
class ExamSessionRestartPreventionTest extends TestCase
{
    ...
    public function test_finished_session_with_saved_answers_cannot_start_again(): void
    {
        ...
        $response->assertSessionHas('status', 'Anda sudah menyelesaikan ujian ini dan jawaban tersimpan.');
    }

    public function test_finished_session_with_saved_answers_cannot_open_exam_room_again(): void
    {
        $user = User::factory()->create([
            'email_verified_at' => now(),
        ]);
